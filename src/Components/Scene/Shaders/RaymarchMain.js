...
void main() {
    ...
    distColor += texture(iChannel0, (nearest.xy + vec2(SampleSize))/Resolution.xy);
    distColor += texture(iChannel0, (nearest.xy + vec2(SampleSize, 0.))/Resolution.xy);
	distColor += texture(iChannel0, (nearest.xy + vec2(0., SampleSize))/Resolution.xy);
